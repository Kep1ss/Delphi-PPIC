object FDataPekerjaan: TFDataPekerjaan
  Left = 0
  Top = 0
  ...
  object P1: TAdvSmoothPanel
    ...
    object AdvSmoothPanel2: TAdvSmoothPanel
      ...
      object DBAdvGrid1: TDBAdvGrid
        ...
        Navigation.AllowEditButtonCells = True
        ...
        Columns = <
          ...
          item
            ...
            CheckTrue = 'Y'
            Color = 15921906
            FieldName = 'biaya_set_mesin'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'Tahoma'
            Font.Style = []
            Header = 'Biaya Set Mesin'
            HeaderFont.Charset = DEFAULT_CHARSET
            HeaderFont.Color = clWindowText
            HeaderFont.Height = -11
            HeaderFont.Name = 'Tahoma'
  ...
  object QJobs: TMyQuery
    Connection = MariaCon.con
    SQL.Strings = (
      
        'SELECT d.name,j.deskripsi,j.biaya,j.satuan,j.biaya_set_mesin,j.k' +
        'oef,'
