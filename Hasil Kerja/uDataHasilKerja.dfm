object FDataHasilKerja: TFDataHasilKerja
  Left = 0
  Top = 0
  Caption = 'Data Hasil Kerja'
  ClientHeight = 459
  ClientWidth = 923
  Color = 11579568
  ...
  object AdvSmoothButton5: TAdvSmoothButton
    ...
    Status.Appearance.Font.Style = []
    BevelColor = clPurple
    Caption = 'Print Plus/Minus Hasil Kerja'
    Color = clGreen
    ParentFont = False
    Picture.Data = {
      89504E470D0A1A0A0000000D4948445200000015000000150806000000A917A5
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44902.863192881950000000
    ...
    ScriptText.Strings = (
      ...
      '    1..4 : Memo64.Color := $00004BE8;'
      '    5..100 : Memo64.Color := clRed;'
      '    -1000..-10 : Memo64.Color := $0053FFFF;'
      '    -10..0 : Memo64.Color := clGreen;'
      '   end;'
      'end;'
      ''
      'begin'
    ...
    object Page1: TfrxReportPage
      ...
      object DetailData1: TfrxDetailData
        ...
        object Memo42: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frDetailHasilKerja."no_container"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo33: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[ROUND(<frDetailHasilKerja."mh">/<frDetailHasilKerja."qty">)]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object frRencanaKerjalembur: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(<frHasilKerja."lembur">*<frHasilKerja."jml_tenaga_kerja">)/200' +
              ']')
          ParentFont = False
        end
        object frRencanaKerjatotal_gaji: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(((<frHasilKerja."gaji">+<frHasilKerja."lembur">) / 200 ) * <fr' +
              'HasilKerja."jml_tenaga_kerja">) ]')
          ParentFont = False
        end
        ...
        object Memo63: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(<frHasilKerja."plus_minus">/200)/ ((((<frHasilKerja."gaji">+<f' +
              'rHasilKerja."lembur">)/200) * <frHasilKerja."jml_tenaga_kerja">)' +
              ') * 100] %')
          ParentFont = False
        end
      end
