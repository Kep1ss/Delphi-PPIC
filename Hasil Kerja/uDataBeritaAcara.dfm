object FDataBa: TFDataBa
  Left = 0
  Top = 0
  Caption = 'Data Berita Acara'
  ClientHeight = 459
  ClientWidth = 923
  Color = 11579568
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44862.628403622690000000
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object frRencanaKerjatotal_gaji: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(((<frRencanaKerja."gaji">/200) * <frRencanaKerja."jml_tenaga_k' +
              'erja">) + <frRencanaKerja."lembur">)]')
          ParentFont = False
        end
        ...
        object Memo103: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '>/200) * <frRencanaKerja."jml_tenaga_kerja">) + <frRencanaKerja.' +
              '"lembur">) * 100] %')
          ParentFont = False
        end
        ...
        object Memo106: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(<frHasilKerja."plus_minus">/200) / (((<frHasilKerja."gaji">/20' +
              '0) * <frHasilKerja."jml_tenaga_kerja">) + <frHasilKerja."lembur"' +
              '> )* 100] %')
          ParentFont = False
        end
