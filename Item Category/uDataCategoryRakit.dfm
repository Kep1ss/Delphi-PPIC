object FDataCategoryRakit: TFDataCategoryRakit
  Left = 0
  Top = 0
  Caption = 'Data Category Rakit'
  ClientHeight = 459
  ClientWidth = 923
  Color = 13619151
  ...
  object QCategoryRakit: TMyQuery
    Connection = MariaCon.con
    SQL.Strings = (
      'SELECT *'
      '              FROM category_rakit')
  ...
  object DKategoriRakit: TMyDataSource
    DataSet = QCategoryRakit
    Left = 304
    Top = 8
  end
end
