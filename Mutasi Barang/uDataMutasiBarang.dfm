object FDataMutasiBarang: TFDataMutasiBarang
  ...
  object P1: TAdvSmoothPanel
    ...
    object AdvSmoothPanel2: TAdvSmoothPanel
      ...
      TabOrder = 3
      TMSStyle = 4
      object sgMutasi: TAdvStringGrid
        Left = 0
        Top = 0
        Width = 839
        Height = 233
        ...
        ScrollBars = ssBoth
        TabOrder = 0
        OnDblClick = sgMutasiDblClick
        HoverRowCells = [hcNormal, hcSelected]
        OnGetAlignment = sgMutasiGetAlignment
  ...
  object DMutasiBarang: TDataSource
    DataSet = QMutasiBarang
    Left = 318
    Top = 244
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44877.442105243060000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'procedure Memo64OnAfterPrint(Sender: TfrxComponent);'
      'begin'
      ''
      ''
      'end;'
    ...
    Datasets = <
      item
        DataSet = frDetailMutasi
        DataSetName = 'frDetailMutasi'
      end
      item
        DataSet = frMutasiBarang
        DataSetName = 'frMutasiBarang'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object DetailData1: TfrxDetailData
        ...
        object Memo42: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frDetailMutasi."nomer_container"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo64: TfrxMemoView
          ...
          Height = 34.015770000000000000
          OnAfterPrint = 'Memo64OnAfterPrint'
  ...
  object frDetailMutasi: TfrxDBDataset
    UserName = 'frDetailMutasi'
    ...
    DataSet = QDetailMutasi
    BCDToCurrency = False
    Left = 470
    Top = 244
  end
  object frMutasiBarang: TfrxDBDataset
    UserName = 'frMutasiBarang'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id=id'
      'code=code'
      ...
      'divisi_id_from=divisi_id_from'
      'divisi_id_to=divisi_id_to'
      'divisifrom=divisifrom'
      'divisito=divisito'
      'keterangan=keterangan'
      'user_id=user_id')
    DataSource = DMutasiBarang
    BCDToCurrency = False
    Left = 406
    Top = 244
  end
  object QMutasiBarang: TMyQuery
    ...
    SQL.Strings = (
      ...
      '                    FROM'
      '                      divisi) dt '
      '                    ON dt.id = m.divisi_id_to ')
    Options.FieldOrigins = foNone
    Active = True
    Left = 246
    Top = 196
  end
  object QDetailMutasi: TMyQuery
    Connection = MariaCon.con
    SQL.Strings = (
      'SELECT '
      '                  d.code,'
