object FDataCategoryProduct: TFDataCategoryProduct
  Left = 0
  Top = 0
  Caption = 'Data Category Product'
  ClientHeight = 459
  ClientWidth = 923
  Color = 13619151
  ...
  object btnAdd: TAdvSmoothButton
    ...
    Width = 125
    Height = 31
    Hint = 'Tambah Data Category Product'
    Anchors = [akTop, akRight]
    Appearance.Font.Charset = DEFAULT_CHARSET
    Appearance.Font.Color = clWhite
    Appearance.Font.Height = -11
  ...
  object AdvSmoothButton3: TAdvSmoothButton
    ...
    Width = 119
    Height = 31
    Hint = 'Export Data Category Product Ke Excelll'
    Anchors = [akTop, akRight]
  ...
  object AdvSmoothButton4: TAdvSmoothButton
    ...
    Width = 101
    Height = 31
    Hint = 'Edit Data Category Product'
    Anchors = [akTop, akRight]
    Appearance.GlowPercentage = 0
    Appearance.Font.Charset = DEFAULT_CHARSET
    Appearance.Font.Color = clWhite
  ...
  object QCategoryProduk: TMyQuery
    Connection = MariaCon.con
    SQL.Strings = (
      'SELECT *'
  ...
  object DKategoriProduk: TMyDataSource
    DataSet = QCategoryProduk
    Left = 304
    Top = 8
  end
end
