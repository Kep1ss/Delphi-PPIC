object FDataDivisi: TFDataDivisi
  Left = 0
  Top = 0
  Caption = 'Data Divisi'
  ClientHeight = 459
      ...
      object DBAdvGrid1: TDBAdvGrid
        ...
        Columns = <
          ...
          item
            ...
            Editor = edColorPickerDropDown
            FieldName = 'initial_color'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindow
            Font.Height = -11
            Font.Name = 'Tahoma'
  ...
  object QDivisi: TMyQuery
    Connection = MariaCon.con
    SQL.Strings = (
      'SELECT divno,name,pic,jmlkaryawan,gaji_karyawan,initial_color,'
      '              id  FROM divisi')
    Options.FieldOrigins = foNone
    Left = 312
    Top = 16
  end
  object DDivisi: TMyDataSource
    DataSet = QDivisi
    Left = 256
    Top = 8
  end
