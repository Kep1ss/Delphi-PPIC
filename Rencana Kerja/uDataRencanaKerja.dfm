object FDataRencanaKerja: TFDataRencanaKerja
  Left = 0
  Top = 0
  Caption = 'Data Rencana Kerja'
  ClientHeight = 459
  ClientWidth = 923
  Color = 11579568
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44883.520100416670000000
    ...
    object Page1: TfrxReportPage
      ...
      object DetailData1: TfrxDetailData
        ...
        object Memo34: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frDetailRencanaKerja."no_container"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo41: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[<frDetailRencanaKerja."mh">/<frDetailRencanaKerja."qty">]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object frRencanaKerjagaji: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(<frRencanaKerja."gaji">/200) * <frRencanaKerja."jml_tenaga_ker' +
              'ja">]')
          ParentFont = False
        end
  ...
  object QDetailRencanaKerja: TMyQuery
    ...
    SQL.Strings = (
      ...
      '              rk.item_id,'
        ...
        '              (case WHEN rk.parent_name <> "" then CONCAT("[",rk' +
        '.parent_name,"]",i.description) else i.description end) descript' +
        'ion,'
      '              rk.qty,'
      '              rk.mh,'
      '              rk.qty_order,'
